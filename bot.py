...
YOUTUBE_API_KEY = "AIzaSyCGs_hqwL8jXbPjKjvTlHTbIErsxgOeAH4"

if not DISCORD_TOKEN:
    raise ValueError("請先在 Render 上設定環境變數 DISCORD_TOKEN")
...
queues = {}  # guild.id -> list of {"url":..., "title":...}
current_song = {}  # guild.id -> current index
...
def search_youtube(query):
    try:
        ...
        print(f"[錯誤] YouTube 搜尋失敗: {query} -> {e}")
        return None, None
